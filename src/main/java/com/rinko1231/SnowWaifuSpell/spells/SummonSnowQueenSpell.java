...
public class SummonSnowQueenSpell extends AbstractSpell {
    ...
    public SummonSnowQueenSpell() {
        this.defaultConfig = new DefaultConfig()
                .setMinRarity(SpellRarity.LEGENDARY) // 冰雪女王稀有度高
                .setSchoolResource(SchoolRegistry.ICE_RESOURCE)
                .setMaxLevel(3) // 三个等级
                .setCooldownSeconds(300.0) // 冷却时间
                .build();
    ...
    public void onCast(Level world, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        ...
        if (!recasts.hasRecastForSpell(this)) {
            ...
            float baseHP;
            switch (spellLevel) {
                case 1 -> { baseHP = 50f; summonTime = 6000; }  // 300 秒
                case 2 -> { baseHP = 100f; summonTime = 9000; } // 450 秒
                case 3 -> { baseHP = 200f; summonTime = 12000; } // 600 秒
                default -> { baseHP = 50f; summonTime = 6000; }  // 防御性默认
            }
